    ...
    >
      <ToastContainer
        ...
        toastStyle={{
          ...
          fontSize: '1rem',
          boxShadow: '0 2px 16px 0 #261f35ff',
      ...
      {/* Contact Form */}
      <div className="container px-3 px-md-4" style={{ maxWidth: 780, backgroundColor: 'var(--background)' }}>
        <motion.form
          className=" p-4 rounded-3 shadow-sm w-100"
          variants={fadeInUp}
          custom={2.5}
          viewport={{ once: true }}
          style={{
        ...
        >
          ...
          <div className="row g-3 mt-1">
            <div className="col-md-6">
              <div className="text-start"><label htmlFor="email" className="form-label fw-semibold text-start" style={{ fontSize: 14, color: "var(--foreground)", }}>
                Email
              </label></div>
              <input
                type="email"
            ...
            <div className="col-md-6">
              <div className="text-start"><label htmlFor="phone" className="form-label fw-semibold text-start" style={{ fontSize: 14, color: 'var(--foreground)' }}>
                Phone
              </label></div>
              <PhoneInput
                country={'pk'}
                ...
                renderCountry={(country) => (
                  <div style={{
                    ...
                    <span style={{ color: "var(--foreground)" }}>+{country.dialCode}</span>
                  </div>
                )}
              />
            </div>
