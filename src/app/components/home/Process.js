...
`.trim();
  ...
  const TOTAL_SLIDES = isMobile ? checklist.length : Math.ceil(checklist.length / 2); // 1 step on mobile, 2 on desktop
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1200, margin: "0 auto", textAlign: "center", }}>
        ...
        {/* Carousel Section */}
        <div className="testimonial-wrapper overflow-hidden mt-6 position-relative" style={{ maxWidth: '1200px', width: '100%', margin: '0 auto' }}>
          ...
          >
            {/* Slide 1: Steps 1 & 2 */}
            <div style={{ flex: "0 0 100%", display: 'flex', gap: '1rem', width: '100%', minWidth: '100%', maxWidth: '100%' }}>
              {/* Step 1 */}
              <div style={{ flex: `0 0 ${isMobile ? '100%' : '50%'}`, width: `${isMobile ? '100%' : '50%'}`, maxWidth: `${isMobile ? '100%' : '50%'}`, boxSizing: 'border-box' }}>
                <motion.div
                  style={{
                ...
                >
                  ...
                  >
                    ...
                    <div className="row g-3">
                      ...
                      <div
                        className="col-12 col-md-6 d-flex flex-column align-items-center justify-content-center p-3"
                        style={{
              ...
              {/* Step 2 - Only show on desktop */}
              {!isMobile && (
                <div style={{ flex: "0 0 50%", width: "50%", maxWidth: "50%", boxSizing: 'border-box' }}>
                  <motion.div
                    style={{
                      background: "var(--card-bg)",
                      border: "1px solid var(--card-border)",
            ...
            {/* Mobile-only slides for Steps 2, 3, 4 */}
            {isMobile && (
              <>
                {/* Mobile Slide 2: Step 2 */}
