...
`.trim();
 ...
 React.useEffect(() => {
  ...
  // Always re-calculate based on screen size & data
  const totalSlides =
    checklist.length === 0
      ? 1
      : isMobile
        ? checklist.length
        : Math.ceil(checklist.length / 2);
    ...
    <motion.span
      ...
      <div style={{ width: "100%", margin: "0 auto", textAlign: "center", }}>
        ...
        >
          ...
          <button
            className="carousel-control-prev absolute top-1/2 left-2 -translate-y-1/2 
             p-2 "
          ...
          >
            ...
            <FaChevronLeft size={20} color="var(--accent)" />
          </button>

          <button
            className="carousel-control-next absolute top-1/2 right-2 -translate-y-1/2  p-2 "
            onClick={nextSlide}
            style={{
          ...
          >
            <FaChevronRight size={20} color="var(--accent)" />
          </button>
